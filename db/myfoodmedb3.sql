...
--
-- Хост: 127.0.0.1
-- Время создания: Апр 22 2014 г., 18:35
...
INSERT INTO `wp_order_details` (`ID`, `OrderNummer`, `prodyctName`, `quontity`, `deliveryAddress`, `deliveryTime`, `extraInfo`, `doneTime`, `done`) VALUES
(1, 66, 'Colorfull set', 3, 'Lund Nordenvägen 7', '10.00-11.00', 'ffffffffff', '0000-00-00 00:00:00', 0),
(2, 45, 'Wine', 1, 'Studentgatan 4 Malmö', '18.00-19.00', 'nmnmnmnmnmnm', '0000-00-00 00:00:00', 0),
(3, 33, 'Yellow flowers', 7, 'Vintergatan 21 21120 Malmö', '12.00-14.00', 'b', '0000-00-00 00:00:00', 0);
